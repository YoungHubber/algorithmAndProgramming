...
int main()
{
    float m1[MAX_DIM][MAX_DIM]= { {1.00, 2.00,  3.00 },
        { 4.00,   5.00,  6.00 }
    };

    float m2[MAX_DIM][MAX_DIM]= {{1.00,2.00},{3.00,4.00},{5.00,6.00}

    };


    float m3[MAX_DIM][MAX_DIM];
    int r1=2,c1=3,r2=3,c2=2,r3,c3,i,j,k;
